...
const CACHE_NAME = "rd-toolkit-v1";
...
// Cache First für alles: erst lokal schauen, nur bei Cache-Miss (z. B. neu
// gebautes JS-Bundle nach einem Update) ins Netz — und das Ergebnis dann
// gleich mit in den Cache legen, damit es beim nächsten Mal auch offline geht.
  ...
  event.respondWith(
    caches.match(event.request).then((cached) => {
      ...
      return fetch(event.request)
        ...
        .catch(() => {
          // Kein Netz UND kein Cache-Treffer (z. B. erster Aufruf ohne Internet):
          // bei Navigationsanfragen wenigstens die App-Shell ausliefern.
