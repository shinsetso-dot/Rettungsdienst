...
const MEDIKAMENTE = [
  {
    ...
    geprueftVon: "Als Foto geprüft — mit Originalprodukt abgeglichen, passt",
...
const ALGORITHMEN = [
  ...
  },
  {
    ...
    version: "V1.5",
    stand: "31.01.2026",
    medikamente: [{ id: "atropin", wann: "Kein AV-Block II Mobitz/III → 0,5 mg i.v., Wdh. alle 3-5 Min. bis max. 3 mg" }],
...
function TapZaehler({ titel, einheit, farbe, Icon, normMin, normMax, warnMin, warnMax }) {
      ...
      <div style={{ width: "100%", maxWidth: 480 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8, marginBottom: 16 }}>
              {[...MEDIKAMENTE_AKTIV].sort((a, b) => a.name.localeCompare(b.name, "de")).map((m) => {
                ...
                return (
                  <div key={m.id}>
                    <button
                      onClick={() => setActiveMed(offen ? null : m.id)}
                      style={{
                        display: "flex",
                        justifyContent: "space-between",
                        alignItems: "center",
                    ...
                    {offen && ergebnisM && (
                      ...
                      >
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
                          ...
                          {m.ampulleGeprueft ? (
                            <Badge tone="ok">
                              GEPRÜFT{m.geprueftAm ? ` · ${m.geprueftAm}` : ""}
                            </Badge>
                          ) : (
                            <Badge tone="warn">
                        ...
                        {m.ampulleGeprueft && (m.geprueftVon || m.handelsname) && (
                          <div style={{ fontSize: 10.5, color: "var(--text-muted)", marginTop: -6, marginBottom: 10 }}>
                            ...
                            {m.geprueftVon ? `geprüft von ${m.geprueftVon}` : ""}
                          </div>
                        )}
                        {!m.ampulleGeprueft && (
                          <div style={{ fontSize: 10.5, color: "var(--text-muted)", marginTop: -6, marginBottom: 10 }}>
                        ...
                        <div style={{ borderTop: "1px solid var(--border)", paddingTop: 12, fontSize: 12.5, color: "var(--text-muted)", lineHeight: 1.5 }}>
                          {m.hinweis}
                        </div>
        ...
        {tab === "metronom" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <TapZaehler titel="Atemfrequenz" einheit="Atemzüge/min" farbe="#60A5FA" Icon={Wind} normMin={12} normMax={20} warnMin={8} warnMax={24} />
